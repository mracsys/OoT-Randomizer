...
hintTable = {
    ...
    'Keaton Mask':                                              (["a famous facade"], "the Keaton Mask", 'item'),
    'Skull Mask':                                               (["a fleshless facade"], "the Skull Mask", 'item'),
    'Spooky Mask':                                              (["a frightening facade"], "the Spooky Mask", 'item'),
    'Bunny Hood':                                               (["a fast facade"], "the Bunny Hood", 'item'),
    'Goron Mask':                                               (["a fraternal facade"], "the Goron Mask", 'item'),
    'Zora Mask':                                                (["a fishy facade"], "the Zora Mask", 'item'),
    'Gerudo Mask':                                              (["a feminine facade"], "the Gerudo Mask", 'item'),
    'Mask of Truth':                                            (["a factual facade"], "the Mask of Truth", 'item'),
