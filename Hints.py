...
class HintArea(Enum):
    # internal name          prepositions        display name                  color         internal dungeon name      Subarea Index (for ER)
    #                        vague     clear
    ROOT                   = 'in',     'in',     "Link's Pocket",              'White',      None,                      None
    HYRULE_FIELD           = 'in',     'in',     'Hyrule Field',               'Light Blue', None,                      None
    LON_LON_RANCH          = 'at',     'at',     'Lon Lon Ranch',              'Light Blue', None,                      None
    MARKET                 = 'in',     'in',     'the market',                 'Light Blue', None,                      0
    MARKET_ENTRANCE        = 'in',     'in',     'the market',                 'Light Blue', None,                      1
    TOT_ENTRANCE           = 'in',     'in',     'the market',                 'Light Blue', None,                      2
    TEMPLE_OF_TIME         = 'inside', 'inside', 'the Temple of Time',         'Light Blue', None,                      None
    CASTLE_GROUNDS         = 'on',     'on',     'the castle grounds',         'Light Blue', None,                      None # required for warp songs
    HYRULE_CASTLE          = 'at',     'at',     'Hyrule Castle',              'Light Blue', None,                      None
    OUTSIDE_GANONS_CASTLE  = None,     None,     "outside Ganon's Castle",     'Light Blue', None,                      None
    INSIDE_GANONS_CASTLE   = 'inside', None,     "inside Ganon's Castle",      'Light Blue', 'Ganons Castle',           None
    KOKIRI_FOREST          = 'in',     'in',     'Kokiri Forest',              'Green',      None,                      None
    DEKU_TREE              = 'inside', 'inside', 'the Deku Tree',              'Green',      'Deku Tree',               None
    LOST_WOODS             = 'in',     'in',     'the Lost Woods',             'Green',      None,                      0
    LOST_WOODS_BRIDGE      = 'in',     'in',     'the Lost Woods',             'Green',      None,                      1
    SACRED_FOREST_MEADOW   = 'at',     'at',     'the Sacred Forest Meadow',   'Green',      None,                      None
    FOREST_TEMPLE          = 'in',     'in',     'the Forest Temple',          'Green',      'Forest Temple',           None
    DEATH_MOUNTAIN_TRAIL   = 'on',     'on',     'the Death Mountain Trail',   'Red',        None,                      None
    DODONGOS_CAVERN        = 'within', 'in',     "Dodongo's Cavern",           'Red',        'Dodongos Cavern',         None
    GORON_CITY             = 'in',     'in',     'Goron City',                 'Red',        None,                      None
    DEATH_MOUNTAIN_CRATER  = 'in',     'in',     'the Death Mountain Crater',  'Red',        None,                      None
    FIRE_TEMPLE            = 'on',     'in',     'the Fire Temple',            'Red',        'Fire Temple',             None
    ZORA_RIVER             = 'at',     'at',     "Zora's River",               'Blue',       None,                      None
    ZORAS_DOMAIN           = 'at',     'at',     "Zora's Domain",              'Blue',       None,                      None
    ZORAS_FOUNTAIN         = 'at',     'at',     "Zora's Fountain",            'Blue',       None,                      None
    JABU_JABUS_BELLY       = 'in',     'inside', "Jabu Jabu's Belly",          'Blue',       'Jabu Jabus Belly',        None
    ICE_CAVERN             = 'inside', 'in'    , 'the Ice Cavern',             'Blue',       'Ice Cavern',              None
    LAKE_HYLIA             = 'at',     'at',     'Lake Hylia',                 'Blue',       None,                      None
    WATER_TEMPLE           = 'under',  'in',     'the Water Temple',           'Blue',       'Water Temple',            None
    KAKARIKO_VILLAGE       = 'in',     'in',     'Kakariko Village',           'Pink',       None,                      None
    BOTTOM_OF_THE_WELL     = 'within', 'at',     'the Bottom of the Well',     'Pink',       'Bottom of the Well',      None
    GRAVEYARD              = 'in',     'in',     'the graveyard',              'Pink',       None,                      None
    SHADOW_TEMPLE          = 'within', 'in',     'the Shadow Temple',          'Pink',       'Shadow Temple',           None
    GERUDO_VALLEY          = 'at',     'at',     'Gerudo Valley',              'Yellow',     None,                      None
    GERUDO_FORTRESS        = 'at',     'at',     "Gerudo's Fortress",          'Yellow',     None,                      None
    GERUDO_TRAINING_GROUND = 'within', 'on',     'the Gerudo Training Ground', 'Yellow',     'Gerudo Training Ground',  None
    HAUNTED_WASTELAND      = 'in',     'in',     'the Haunted Wasteland',      'Yellow',     None,                      None
    DESERT_COLOSSUS        = 'at',     'at',     'the Desert Colossus',        'Yellow',     None,                      None
    SPIRIT_TEMPLE          = 'inside', 'in',     'the Spirit Temple',          'Yellow',     'Spirit Temple',           None
